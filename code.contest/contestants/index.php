	...
	<body>
		<div class="color-wrap fade-in-bottom">
			<div class=WordSection1>
				...
				<p class=MsoTitle>
					project.powercode contest - participants
				</p>
				<p style="font-family: 'book'!important;">here is the list of contestants in this contests. the list will be daily updated. if you have applied but haven't seen your name yet, don't worry, we'll add yours soon. contact me if you still haven't seen your 3 days after applying. </p>
				<p class=MsoNormal>
					<h2>date updated: <b style="color: yellow" class="nitrotime"></b> </h2>
				</p>
				<?php
					$mem = json_decode($GLOBALS['listMember'],true);
					foreach ($mem["members"] as $m) {
						...
						echo '
						<p class=MsoNormal >
							<div class="member-container" title="'.$ur.' from '.$sv.'">
